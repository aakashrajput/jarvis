...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  // api.ai client
  const apiClient = new ApiAi.ApiAiClient({accessToken: '96ca83b1f76e4ae7a69b1818e2097242'});

  // Initial feedback message.
  addBotItem("Hi! I’m Jarvis. Tap the microphone and start talking to me or save my name in your contacts and text me (+1 315 892-1750).");
